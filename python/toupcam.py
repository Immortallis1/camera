...
TOUPCAM_OPTION_VOLTAGEBIAS            = 0x7f       # Voltage bias
TOUPCAM_OPTION_VOLTAGEBIAS_RANGE      = 0x80       # Voltage bias range: min (low 16bits), max (high 16bits)
...
class Toupcam:
    ...
    @classmethod
    def Version(cls):
        """get the version of this dll, which is: 58.28395.20250428"""
        cls.__initlib()
